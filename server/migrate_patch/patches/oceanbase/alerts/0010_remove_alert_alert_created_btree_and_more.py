...
#       - AddIndex (JSONField): OceanBase 不支持 JSON 列直接索引 (错误码 3152)，跳过创建
...
class FakeAddIndex(migrations.AddIndex):
    """跳过 JSONField 上的索引创建，OceanBase 不支持 JSON 列直接索引"""
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # --- AddIndex: JSONField 索引全部跳过，OceanBase 不支持 JSON 列直接索引 ---
        FakeAddIndex(
            model_name="alert",

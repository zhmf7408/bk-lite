...
#       - AddIndex (JSONField): GaussDB ubtree 不支持 jsonb 类型索引，跳过创建
...
class FakeAddIndex(migrations.AddIndex):
    """跳过 JSONField 上的索引创建，GaussDB ubtree 不支持 jsonb 类型索引"""
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # --- AddIndex: JSONField 索引全部跳过，GaussDB ubtree 不支持 jsonb 类型索引 ---
        FakeAddIndex(
            model_name="alert",
